...
function messageListener(Meet) {
    return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, Meet.page.evaluate(function () {
                                var chat = document.querySelector(".z38b6").lastChild;
                                return {
                        ...
                        case 1:
                            message = _a.sent();
                            if (!(message.author !== "You")) return [3 /*break*/, 3];
                            return [4 /*yield*/, Meet.emit("message", message)];
                        case 2:
                            _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Meet.page.waitForSelector(".GDhqjd", { timeout: 0 })];
                case 1:
                    _a.sent();
                    getRecentMessage();
                    return [4 /*yield*/, Meet.page.exposeFunction("getRecentMessage", getRecentMessage)];
                case 2:
                    _a.sent();
